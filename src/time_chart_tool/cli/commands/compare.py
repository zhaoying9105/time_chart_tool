...
from ...analyzer import analyze_multiple_files
...
class CompareCommand:
    ...
    def run(self, args) -> int:
        ...
        # 解析compare选项
        try:
            compare_attributes = parse_compare_options(args.compare)
            print(f"比较选项: {compare_attributes}")
        except ValueError as e:
        ...
        try:
            ...
            # 使用新的分析流程
            generated_files = analyze_multiple_files(
